            ...
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                        ...
                        <?php } ?>
                        <form method="POST" class="register-form" id="register-form" action="<?php echo base_url('login/processRegister');?>">
                            ...
                            <div class="form-group form-button">
                                ...
                                <a href="<?php echo base_url('login/index');?>"><input type="button" class="form-cancel" id="sign up" value="Back"/></a>
                            </div>
                        </form>
                    </div>
